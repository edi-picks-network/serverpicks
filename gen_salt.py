...
prompt = (
    "Generate a JSON object for the 'Salt Project' tool entry. "
    "Salt Project is an open-source, Python-based infrastructure automation and configuration management platform "
    "designed for scalable, real-time remote execution and state-driven orchestration across hybrid cloud environments.\n\n"
