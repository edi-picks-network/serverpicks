...
prompt = (
    "Generate a JSON object for the 'Supabase' tool entry for a cloud/VPS hosting comparison site. "
    "Supabase is an open-source Firebase alternative that provides PostgreSQL database, authentication, "
    "real-time subscriptions, storage, and edge functions in a single platform.\n\n"
