...
export const ALL_TOOLS: ToolData[] = [
  ...
  },
  {
    ...
    pros: [
    "Blazing-fast NVMe SSD storage across all plans",
    "Global data center presence with low-latency options in 8 regions",
    "Real-time monitoring and intuitive dashboard with one-click scaling",
    "Robust DDoS protection included at no extra cost",
    "Transparent pricing with no hidden fees or overage charges",
    "Excellent API documentation and CLI tooling for automation",
    "99.99% uptime SLA backed by real financial compensation",
    "Free automated backups and on-demand snapshot capability",
],

    cons: [
    "No free tier or trial credits for new users",
    "Limited Windows OS templates compared to competitors",
    "No built-in website builder or managed WordPress option",
    "Customer support response times can lag during peak hours",
],

    pricing: "From $5/mo",
    pricingDetail: "UpCloud offers transparent, hourly-billed VPS plans starting at $5/month for the smallest configuration (1 vCPU, 1 GB RAM, 25 GB NVMe SSD), scaling up to $299/month for high-end instances with 16 vCPUs, 64 GB RAM, and 1 TB NVMe storage. All plans include unmetered bandwidth, free automated backups, DDoS protection, and private networking. Pricing is consistent across all eight global data centers\u2014Helsinki, London, Chicago, New York, San Jose, Singapore, Sydney, and Frankfurt\u2014with no regional surcharges. Users pay only for what they use, with billing calculated to the second and invoices generated monthly. Optional add-ons include reserved IPs ($1/month), additional storage volumes ($0.05/GB/month), and GPU instances ($0.75/hour). There are no setup fees, contract lock-ins, or cancellation penalties. While UpCloud lacks a free tier, new users receive $25 in credit upon verification\u2014enough for roughly five months of the entry-level plan. Discounts apply for annual billing, offering up to 10% savings versus monthly rates.",
    features: [
    "UpCloud uses enterprise-grade NVMe SSDs exclusively, delivering up to 3x faster I/O performance than SATA SSD VPS providers",
    "Each server includes a dedicated public IPv4 address and optional IPv6, with flexible firewall rules configurable per server",
    "The Cloud Manager dashboard provides real-time CPU, memory, disk, and network graphs with customizable alert thresholds",
    "Automated daily backups are available for all plans, retaining up to 7 restore points with point-in-time recovery",
    "One-click application deployments include LAMP, Node.js, Docker, and Kubernetes clusters with preconfigured networking",
    "Private networking allows secure inter-server communication across data centers using encrypted VXLAN tunnels",
    "Custom ISO upload enables installation of any Linux distribution or custom OS image directly from your browser or API",
    "Live migration technology permits hardware upgrades and maintenance without downtime or manual intervention",
    "Integrated DNS management supports domain registration, zone delegation, and dynamic DNS updates via API",
    "GPU-accelerated instances are available for ML training and rendering workloads, with NVIDIA Tesla T4 support",
    "SSH key management is enforced by default, with optional two-factor authentication for account-level security",
    "Bandwidth is unmetered and fully included—no throttling or overage fees regardless of traffic volume",
],
