...
export const metadata: Metadata = {
  title: "Terms of Service — Server Picks",
  description:
    "Read the Terms of Service for Server Picks. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#839BBE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the Server Picks website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              Server Picks is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by Server Picks and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of Server Picks. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by Server Picks. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              Server Picks offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Server Picks, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Server Picks and its
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1F2D] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-[#F0F2FE]">Email:</strong> legal@serverpicks.net</p>
              <p className="mb-2"><strong className="text-[#F0F2FE]">Support:</strong> support@serverpicks.net</p>
