...
export const metadata: Metadata = {
  title: "Terms of Service — Ever Driven",
  description:
    "Read the Terms of Service for Ever Driven. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#839BBE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the Ever Driven website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              Ever Driven is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by Ever Driven and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of Ever Driven. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by Ever Driven. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              Ever Driven offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Ever Driven, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Ever Driven and its
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1F2D] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-[#F0F2FE]">Email:</strong> team@everdriven.io</p>
              <p className="mb-2"><strong className="text-[#F0F2FE]">Support:</strong> team@everdriven.io</p>
